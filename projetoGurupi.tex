...
%ISSUE: folha de aprovação
	\begin{center}
	 ...
	 Trabalho aprovado. \imprimirlocal, 08 de fevereiro de 2018:
% ISSUE: Data da folha de aprovação

	 \assinatura{\textbf{\imprimirorientador} \\ Orientador} 
	 \assinatura{\textbf{Prof. Dr. Francisco Carlos Bentes Frey Müller} \\ Convidado 1}
	 \assinatura{\textbf{Prof. Dr. Evaldo Gonçalves Pelaes} \\ Convidado 2}
...
\begin{siglas}
	...
	\item[POCS] \emph{Projection Onto Convex Sets}
	\item[MAP] \emph{Maximum a Posteriori}
...
\input{./tex/intro.tex}
\input{./tex/superRes.tex}
\input{./tex/metodosSuperRes.tex}
\input{./tex/bayesSR.tex}
