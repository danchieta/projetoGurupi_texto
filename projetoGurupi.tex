...
Hoje em dia, com a desanimadora realidade da seguranção pública em países como o Brasil, os cidadãos sentem a necessidade de investir na própria segurança privada para proteger a si mesmos e seus patrimônios.
...
No entanto, apesar da presença geral dos sistemas de vigilância, os a maioria dos equipamentos utilizados é de baixa qualidade, o que se reflete nas imagens captadas por eles.
A consequência disso é que muitas vezes as câmeras de monitoramento registram cenas importantes de crimes ou outros casos policiais,
mas as imagens de baixa qualidade nem sempre ajudam a trazer à luz informações importantes, como o rosto de um crimioso ou a placa de um carro, por exemplo.

Apesar da necessidade evidente de se usar câmeras de alta resolução para sistemas de monitoramento, também há o dilema consntante entre aumentar a qualidade das imagens registradas e o custo de implementar manter o sistema de monitoramento funcionando.
