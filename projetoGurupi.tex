...
Hoje em dia, com realidade da segurança pública em países como o Brasil, os cidadãos sentem a necessidade de investir na própria segurança privada para proteger a si mesmos e seus patrimônios.
...
Desde o fim dos anos 50, quando iniciou a corrida espacial entre os EUA e a URSS, há a necessidade de técnicas de restauração de imagens de sondas e satélites.
Essa necessidade foi causada pelo fato de que o ambiente onde as sondas e satélites eram colocados submetia as imagens captadas a diversos tipos de degradação.
