...
\begin{figure}[h]
	...
	% ISSUE: Esta figura é provisória
...
% ISSUE: Figuras da etapa de otimização dos parâmetros
...
% ISSUE: Verificar os valores de número de interações, número máximo de avaliações da função 
