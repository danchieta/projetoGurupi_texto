...
\begin{figure}[H]
	...
	\begin{minipage}[b]{.99\linewidth}
		...
		\subcaption{\label{fig:progression} Progressão do valor da função de verossimilhança e do erro ao longo das iterações do algoritmo de otimização.}
	\end{minipage}

	\begin{minipage}[b]{.99\linewidth}
		\centering
		\includegraphics[width=0.90\textwidth]{./figures/results_figures/progression_plot2.pdf}
		\subcaption{\label{fig:comparisson} Comparação dos resultados obtidos durante a otimização com os parâmetros verdadeiros.}
